...
#
# After this script completes, build login-tools with:
...
BUILD_TMP="$(mktemp -d -t login-tools-musl-build.XXXXXX)"
...
# Configure
#
# Use the host gcc with -m32 to produce an i386 static library.
# ---------------------------------------------------------------------------
CC="${CC:-gcc}"
...
echo ""
echo "  Build login-tools now with:"
